...
SyllabiRequestVouching.getLayout = function getLayout(page) {
  return <Layout>{page}</Layout>
}

export default function SyllabiRequestVouching() {
  ...
  const handleViewDetails = (request) => {
    router.push(`/hod/${request.id}/preview`)
  }
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      await rejectSyllabus(selectedRequest.id)
