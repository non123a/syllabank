...
const SyllabusPreview = () => {
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      router.push(PATH_DASHBOARD.provost.syllabiRequests)
    } catch (error) {
    ...
    <DashboardLayout>
      ...
      <Container maxWidth="xl">
        <HeaderBreadcrumbs
          ...
          links={[
            { name: 'Dashboard', href: PATH_DASHBOARD.general.home },
            {
              ...
              href: PATH_DASHBOARD.provost.syllabiRequests
            },
        ...
        <Box sx={{ mt: 2 }}>
          <Button
            variant="outlined"
            onClick={() => router.push(PATH_DASHBOARD.provost.syllabiRequests)}
          >
